$(function() {
    ...
    liHasChild_level1.on({
      ...
      mouseleave: function() {
        ...
        $(this).children('ul').stop(true, true).slideUp('600', 'easeOutQuint');
            ...
            _search.hide();
            _floatmenu.insertAfter('header h1');
  ...
  $('.btn-fatfooter').click(function(e) {
    $(this).parent('.container').find('nav>ul>li>ul').stop(true, true).slideToggle(function() {
      if ($(this).is(':visible')) {
        $('.btn-fatfooter').html("CLOSE<br />收合");
        $('.btn-fatfooter').attr('name', 'CLOSE<br />收合選單');
        e.preventDefault();
      } else {
        $('.btn-fatfooter').html("OPEN<br />展開");
        $('.btn-fatfooter').attr('name', 'OPEN<br />展開選單');
        e.preventDefault();
      }
    });
